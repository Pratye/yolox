...
# -*- coding:utf-8 -*-
"""
Convenience script for training YOLOX on crater detection dataset.

This script sets the default experiment file to the crater configuration.

Usage:
    python train_crater.py -b 64 -d 1
    
Or use the standard training script directly:
    python tools/train.py -f exps/example/custom/crater_yolox_s.py -b 64 -d 1
"""
...
def make_parser():
    ...
    parser.add_argument("-f", "--exp_file", default="exps/example/custom/crater_yolox_s.py", type=str, 
