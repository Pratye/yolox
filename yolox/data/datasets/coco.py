...
def remove_useless_info(coco):
    ...
    if isinstance(coco, COCO):
        ...
        # Keep 'info' field as it's needed for evaluation (pycocotools.loadRes)
...
class COCODataset(CacheDataset):
    ...
    def __init__(
        ...
        # Load COCO data first to get num_imgs
        ...
        # Now initialize CacheDataset with correct parameters
